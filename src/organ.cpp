...
Organ::Organ(std::string organ_nume, double total, double reg) : nume(std::move(organ_nume)), cSanatoase(total), cInfectate(0), cMoarte(0), rataRegenerare(reg), totalInitial(total) {}
